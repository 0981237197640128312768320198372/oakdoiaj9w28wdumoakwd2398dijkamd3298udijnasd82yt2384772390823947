  ...
  return (
    <div className='flex justify-center items-center flex-col gap-24'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10'>
        <Dialog>
          <DialogTrigger>
            <button className='btn btn-assName='flex flex-col justify-between items-start py-2 px-3 border-primary border-2 '>
          ...
          <DialogContent className='bg-dark-800 border-primary rounded'>
            <DialogHeader>
