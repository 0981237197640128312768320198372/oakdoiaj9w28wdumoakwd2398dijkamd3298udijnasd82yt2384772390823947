...
export const metadata: Metadata = {
  ...
  description:
    "แพลตฟอร์มสินค้าดิจิทัลสำหรับทุกคนที่ต้องการ Netflix Premium ราคาถูก คุณภาพดีที่ Dokmai Store",
  icons: {
    icon: "./favicon.ico",
    apple: "./apple-touch-icon.png",
  },
  keywords:
    "Netflix Premium, บัญชี Netflix, บริการสตรีมมิ่ง, ดูหนังออนไลน์, ดูซีรีส์, บัญชีราคาถูก, Dokmai Store, ซื้อ Netflix ราคาถูก",
  openGraph: {
    type: "website",
    ...
    images: [
      {
        url: "https://www.dokmaistore.com/og-image.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [
      {
        url: "https://www.dokmaistore.com/twitter-image.jpg",
        alt: "Netflix Premium คุณภาพสูง ราคาถูก ที่ Dokmai Store",
      },
    ],
  },
