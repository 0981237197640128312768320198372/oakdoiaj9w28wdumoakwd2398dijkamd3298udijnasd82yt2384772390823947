  ...
  return (
    <html lang='en' className='!scroll-smooth'>
      <body className='antialiased font-mono min-h-screen bg-dark-800 text-light-200'>
        ...
        <div className='w-full py-1 h-fit fixed bottom-0 flex justify-center items-center bg-cyan-500 sm:bg-blue-500 md:bg-green-500 lg:bg-yellow-500 xl:bg-orange-500 2xl:bg-red-500 '>
          <p className='sm:hidden'>MOST SMALL</p>
        </div>
      </body>
    </html>
  )
