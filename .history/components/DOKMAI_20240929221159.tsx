  ...
  return (
    ...
    >
      ...
      <text
        ...
        strokeWidth='0.2'
        className='font-aktivGroteskBold stroke-light-500 md:stroke-dark-500 fill-transparent text-7xl  '
      ...
      <motion.text
        ...
        dominantBaseline='middle'
        strokeWidth='0.2'
        className='font-aktivGroteskBold fill-transparent text-7xl stroke-light-500 md:stroke-dark-500'
