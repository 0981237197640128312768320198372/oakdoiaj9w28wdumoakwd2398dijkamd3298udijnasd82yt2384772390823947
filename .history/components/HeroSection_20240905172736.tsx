...
const HeroSection = () => {
    return (
        <div className='flex flex-col-reverse lg:flex-row justify-between w-full h-[650px] mb-5 rounded-2xl bg-light-200 dark:bg-dark-500 overflow-hidden p-10 shadow-lg border-[1px] border-primary dark:border-none'>
