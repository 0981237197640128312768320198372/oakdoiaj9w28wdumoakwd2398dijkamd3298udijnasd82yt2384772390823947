        ...
        <div className='flex flex-col lg:max-w-[700px] h-fit gap-5'>
          <div className='flex flex-col justify-start gap-2'>
            ...
            <span className='font-mono opacity-65'>
              ...
              completing your payment via Stripe, simply send us a screenshot of
              the confirmation. It&apos;s that easy to continue enjoying your
              Netflix access!
            </span>
            <button
              className='flex !px-3 !py-2 !border-none text-white w-fit border border-2 bg-transparent border-primary hover:bg-primary'
              onClick={() => {
