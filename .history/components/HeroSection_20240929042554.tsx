  ...
  return (
    ...
    >
      <div className='h-screen flex flex-col justify-start items-center text-center px-4'>
        ...
        <p className='text-xl md:text-2xl text-gray-200 max-w-xl mx-auto w-full bg-red-600 font-mono'>
          High Quality{" "}
          <span className='text-dark-800 bg-primary p-1'>Netflix Premium</span>{" "}
