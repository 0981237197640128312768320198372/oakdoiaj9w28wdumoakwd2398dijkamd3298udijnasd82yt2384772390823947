...
const HeroSection = () => {
  return (
    ...
    >
      <div className='flex flex-col justify-start items-center text-center px-4 w-full bg-red-500'>
        <h1 className='text-3xl md:text-6xl font-aktivGroteskMedium text-white mb-4'>
          Watch More Series, <br className='sm:hidden' /> Spend Less Money
        </h1>
        <p className='text-xl md:text-xl text-gray-200 max-w-xl mx-auto font-mono'>
          High Quality{" "}
