  ...
  return (
    ...
    >
      ...
      <Link
        ...
        target='_blank'
        className='text-light-100 border-b-2 p-2 font-aktivGroteskBold text-3xl border-primary hover:border-0 hover:bg-primary hover:text-dark-800 duration-300'
      >
        Order Now!
      </Link>
    </section>
