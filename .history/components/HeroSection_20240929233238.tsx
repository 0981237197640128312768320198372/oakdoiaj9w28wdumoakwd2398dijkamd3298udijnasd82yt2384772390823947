...
const HeroSection = () => {
  return (
    <section
      id='HeroSection'
      className='flex flex-col justify-start items-center pt-5 __container gap-10'
    >
      ...
      <Link
        ...
        target='_blank'
        className='text-light-100 border-b-2 p-2 font-aktivGroteskBold xl:text-3xl border-primary hover:border-0 hover:bg-primary hover:text-dark-800 duration-500'
      >
        Order Now
      </Link>
    </section>
