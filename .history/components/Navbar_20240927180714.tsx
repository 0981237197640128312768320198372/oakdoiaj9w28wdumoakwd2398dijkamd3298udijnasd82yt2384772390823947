...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className='w-full gap-10 dark:bg-dark-800 bg-gray-200/50 py-1 flex px-6 justify-between duration-1000 items-center shadow-lg shadow-black/25 dark:shadow-black/70'>
