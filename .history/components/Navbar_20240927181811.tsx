  ...
  return (
    ...
    >
      <div className='w-full gap-10 bg-dark-800 py-1 flex px-6 justify-between duration-1000 items-center '>
        <Link
          href='/'
          className='flex select-none items-center gap-1 py-3 bg-red-600 w-fit'
        >
          <Image
            width={100}
            height={100}
        ...
        <div className='flex items-center justify-end gap-5 lg:gap-10 bg-red-600'>
          ...
          <div className='flex justify-center items-center gap-3 md:gap-5 lg:gap-5 hidden max-md:flex'>
            <MobileNav />
          </div>
        </div>
      </div>
