...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className='w-full gap-10 bg-dark-800 py-1 flex px-36 py-10 justify-between duration-1000 items-center '>
        <Link
          href='/'
          className='flex select-none items-center gap-1 p-3 bg-red-600 w-fit'
        >
          <Image
            width={100}
            height={100}
        ...
        <div className='flex items-center justify-end gap-5 bg-red-600'>
