  ...
  return (
    ...
    >
      ...
      <div className='w-full gap-10 pt-2 flex px-10 lg:px-60 justify-between duration-1000 items-center'>
        <div className='flex w-full justify-between items-center bg-dark-800 max-md:hidden lg:text-md'>
          <div className=' w-full flex gap-5 justify-between items-center bg-red-500'>
