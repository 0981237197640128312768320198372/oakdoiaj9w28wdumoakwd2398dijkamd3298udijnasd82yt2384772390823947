    ...
    >
      <div className='w-full gap-10 bg-dark-800 py-5 flex px-10 lg:px-60 justify-between duration-1000 items-center '>
        ...
        <div className='flex items-center justify-end gap-5'>
          <div className='justify-end items-center gap-3 font-aktivGroteskBold hidden max-md:flex'>
            <Link
            ...
            <Link
              href='https://dokmaistore.mysellix.io'
              className='text-dark-800 bg-primary px-2 py-1 flex items-center gap-2 '
            >
