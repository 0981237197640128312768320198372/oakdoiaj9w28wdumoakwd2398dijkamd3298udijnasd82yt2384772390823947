...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className='w-full gap-10 bg-dark-800 py-5 flex px-10 xl:px-60 justify-between duration-1000 items-center '>
        ...
        <div className='flex items-center justify-end gap-5'>
          <div className='flex justify-end items-center gap-3 font-aktivGroteskBold '>
            <Link
              ...
              className='border-[1px] border-primary px-2 py-1 hidden xl:block'
            >
              Buy Now
            </Link>
            <Link
              href='https://dokmaistore.mysellix.io'
              className='text-dark-800 bg-primary px-2 py-1 items-center gap-2 hidden xl:flex'
            >
      ...
      <div className='w-full gap-10 pt-2 flex px-10 xl:px-60 justify-between duration-1000 items-center'>
        <div className='flex w-full justify-between items-center bg-dark-800/50 backdrop-blur max-md:hidden xl:text-md p-2'>
