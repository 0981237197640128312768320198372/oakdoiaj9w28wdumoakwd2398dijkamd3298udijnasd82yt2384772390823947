...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "You can install TailwindCSS using npm or yarn, and configure it in your Next.js or React project.",
  },
  {
...
const FAQSection = () => {
  ...
  return (
    ...
    >
      ...
      />
      {faqs.map((faq, index) => (
        <div key={index} className='border-b-2 border-gray-200 __nofocus'>
          <button
