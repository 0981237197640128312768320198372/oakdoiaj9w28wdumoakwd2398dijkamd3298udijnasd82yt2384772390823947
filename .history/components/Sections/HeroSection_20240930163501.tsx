    ...
    >
      <div className='flex flex-col justify-start items-center text-center w-full'>
        ...
        <p className='md:text-xl text-light-200 font-mono text-xs'>
          High Quality Cheap Price with Lifetime Warranty from Dokmai Store, the
          best digital goods platform in{" "}
          ...
          แพลตฟอร์มสินค้าดิจิทัลที่ดีที่สุด[ในประเทศไทย] รับบริการ Netflix
