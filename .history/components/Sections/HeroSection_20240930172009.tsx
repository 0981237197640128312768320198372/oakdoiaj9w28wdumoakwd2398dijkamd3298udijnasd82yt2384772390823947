    ...
    >
      <div className='flex flex-col justify-start items-center text-center w-full'>
        ...
        <Link
          ...
          target='_blank'
          className='text-light-100 border-b-2 px-2 pt-5 mt-5 font-aktivGroteskBold xl:text-3xl border-primary hover:border-0 hover:bg-primary hover:text-dark-800 duration-500'
        >
          สั่งซื้อตอนนี้
        </Link>
      </div>
