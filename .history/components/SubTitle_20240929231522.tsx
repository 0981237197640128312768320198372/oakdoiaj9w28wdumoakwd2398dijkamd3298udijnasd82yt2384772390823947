...
const SubTitle = ({
  ...
  return (
    <div
      className={`flex gap-5 w-full justify-between items-center md:px-0 bg-red-500  __container ${className}`}
    >
      ...
      <Link
        ...
        href={urlButtonMore}
      >
        <span className='flex justify-end items-center w-full bg-green-500'>
          {buttonMore}
        </span>
      </Link>
    </div>
