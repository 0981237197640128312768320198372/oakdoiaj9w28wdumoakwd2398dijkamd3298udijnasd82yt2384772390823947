...
const SubTitle = ({
  ...
  return (
    <div
      className={`flex gap-7 w-full justify-between items-center p-5 xl:p-0 __container border-b-[1px] border-light-200 flex-col-reverse py-[3px] hover:py-[1px] duration-300 ${className}`}
    >
