          ...
          >
            <blockquote className='bg-red-200 h-full'>
              <Image
                ...
                className='mb-5'
              />
              <span className='relative text-xl mb-4 text-light-200 font-normal bg-blue-600'>
                {item.title}
              </span>
              <div className='relative h-full flex flex-row items-start text-light-600 pt-3 bg-yellow-400'>
