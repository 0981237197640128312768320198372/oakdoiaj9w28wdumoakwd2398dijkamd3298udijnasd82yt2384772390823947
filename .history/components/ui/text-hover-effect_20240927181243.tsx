  ...
  return (
    ...
    >
      ...
      <text
        ...
        strokeWidth='0.1'
        className='font-[helvetica] font-bold stroke-dark-600 fill-transparent text-4xl  '
      ...
      <motion.text
        ...
        dominantBaseline='middle'
        strokeWidth='0.1'
        className='font-[helvetica] font-bold fill-transparent text-4xl  stroke-dark-600'
