  ...
  return (
    ...
    >
      ...
      <text
        ...
        strokeWidth='0.1'
        className='font-aktivGroteskBold stroke-dark-500 fill-transparent text-7xl flex flex-col items-start gap-0'
      ...
      <motion.text
        ...
        dominantBaseline='middle'
        strokeWidth='0.1'
        className='font-aktivGroteskBold fill-transparent text-7xl  stroke-dark-500 flex flex-col items-start gap-0'
