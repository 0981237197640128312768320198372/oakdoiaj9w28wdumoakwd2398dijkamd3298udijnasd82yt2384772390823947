  ...
  return (
    ...
    >
      ...
      <text
        ...
        strokeWidth='0.1'
        className='font-aktivGroteskBold stroke-dark-600 fill-transparent text-7xl flex flex-col gap-0 w-full h-full'
      ...
      <text
        ...
        strokeWidth='0.1'
        mask='url(#textMask)'
        className='font-aktivGroteskBold fill-transparent text-7xl flex flex-col gap-0'
      >
        <tspan x='50%' dy='-0.5em'>
          DOKMAI
        </tspan>
