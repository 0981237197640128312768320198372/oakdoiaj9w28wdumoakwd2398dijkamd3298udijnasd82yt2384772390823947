  ...
  return (
    ...
    >
      ...
      <text
        ...
        strokeWidth='0.1'
        className='font-aktivGroteskBold stroke-dark-600 fill-transparent text-9xl flex flex-col gap-0 '
      ...
      <motion.text
        ...
        dominantBaseline='middle'
        strokeWidth='0.1'
        className='font-aktivGroteskBold fill-transparent text-9xl  stroke-dark-600 flex flex-col gap-0'
