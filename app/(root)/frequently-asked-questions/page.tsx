import FAQList from '@/components/home/general/FAQList';
...
export const metadata = generateMetadata({
  ...
  keywords: 'คำถามที่พบบ่อย, Netflix Premium, Prime Video, บัญชีพรีเมียม, Dokmai Store',
});

export default function Page() {
  return (
    <div className="flex flex-col justify-center w-full items-start px-5 xl:px-0 pt-10 xl:pt-28 __container">
      <PageHeadline headline="Frequently Asked Questions" description="คำถามที่พบบ่อย" />
