...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className="font-aktivGroteskRegular min-h-screen bg-dark-800 text-light-200 overflow-x-hidden selection:bg-fuchsia-500/30 selection:text-fuchsia-500 flex flex-col justify-start w-full items-center">
