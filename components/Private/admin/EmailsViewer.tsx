          ...
          <div className="w-full max-h-[700px] flex flex-col overflow-y-auto __dokmai_scrollbar">
            {filteredEmails.reverse().map((email) => (
              <div
                ...
                <p className="text-xs font-aktivGroteskThin">From: {email.from}</p>
      ...
      {selectedEmail && (
        <div
          ...
          <div
            ...
            <p className="font-aktivGroteskBold text-sm">{selectedEmail.subject}</p>
            <p className="text-xs font-aktivGroteskThin">From: {selectedEmail.from}</p>
