...
const InventoryCreationWizard: React.FC<InventoryCreationWizardProps> = ({
  ...
  // Render the wizard using a plain div instead of a Modal component
  return (
    <>
      {isOpen && (
        <div className="p-5 border border-dark-600 rounded-lg bg-dark-800 shadow-lg">
          <div className="p-5">
