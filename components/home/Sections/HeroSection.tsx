...
const HeroSection = () => {
  return (
    <section id="HeroSection" className="flex flex-col w-full justify-start items-center pt-10">
      <DOKMAI text="DOKMAI" />
      <div className="flex flex-col justify-start px-5 lg:p-0 __container items-start text-center w-full">
        ...
        <p className="md:text-xl text-light-200 text-start font-mono text-xs">
          ...
          เช่น
          <Highlight text="Netflix Premium" bgcolor="bg-[#e50914] !text-black whitespace-nowrap" />
          และ
          <Highlight text="Prime Video" bgcolor="bg-[#00aae4] !text-white whitespace-nowrap" />
          ใน
          <Highlight
